...
class TicketWidgetTest extends StatefulWidget {
  Movie movie;

  TicketWidgetTest({this.movie});

  @override
  _TicketWidgetState createState() => _TicketWidgetState();
}

class _TicketWidgetState extends State<TicketWidgetTest> {
  String selectedValue = 'Adult';
  @override
